...
|**vbDataObject**|13|A (VBA) object type with a particular interface chosen, that is not represented by the **vbObject** constant documented in this table. [&Dagger;](#doubledaggerfootnote "An object of such an object type, like all VBA objects, is still a COM object. Like all COM objects and interfaces, such objects expose COM's IUnknown interface. Not to be confused with ActiveX Data Objects (ADO) which is a database technology.")|
