...
The required _arg_ argument must be of the **Variant** type, or be able to be [coerced](../../Reference/User-Interface-Help/data-type-summary.md#implicit-conversions-and-casts) to it.
