...
| _arglist_|Required. List of variables representing arguments that are passed to the **Property Let** procedure when it is called. Multiple arguments are separated by commas. The name and [data type](../../Glossary/vbe-glossary.md#data-type) of each [parameter](../../glossary/vbe-glossary.md#parameter) (variable representing argument) in a **Property Let** procedure must be the same as the corresponding variable of the **Property Get** procedure (corresponding variable is either one of the parameters or the return variable, of the **Property Get** procedure).|
