...
| _type_|Optional. Data type of the argument passed into the procedure; may be **Byte**, **Boolean**, **Integer**, **Long**, **Currency**, **Single**, **Double**, **Decimal** (not currently supported), **Date**, **String** (variable length only), **Object**, **Variant**, or a specific [object type](../../Glossary/vbe-glossary.md#object-type). If the parameter is not **Optional**, a user-defined type may also be specified.|
...
The data types specified for arguments in a **Property Get** procedure definition, are often identical to the data types required by the corresponding parameters of standard [procedure calls](../../glossary/vbe-glossary.md#procedure-call) of the **Property Get** procedure. However, when the function specifies a **Variant**, **Object**, or a specific object type for an argument, automatic implicit type conversions sometimes take place such that the range of the call parameter is broader than the range of the argument type specified by the **Property Get** procedure. See the ['Implicit conversions'](data-type-summary.md#implicit-conversions) section on the 'Data type summary' page for more information.
