...
|**[Currency](currency-data-type.md)**<BR><sup>_(scaled integer)_</sup>|8|-_a_&nbsp;&nbsp;to&nbsp;&nbsp;(_a_&thinsp;-&thinsp;0.0001)&nbsp;&nbsp;where _a_ = 922,337,203,685,477.5808 and where value must have no more than 4 decimal places.|
...
|**[Double](double-data-type.md)** <BR><sup>_(double&#8209;precision floating-point)_</sup>|8|-_a_ to (_a_ + 10<sup>-14</sup>) where _a_ = 1.79769313486231 × 10<sup>308</sup>|
...
|**[Single](single-data-type.md)**<BR><sup>_(single&#8209;precision floating&#8209;point)_</sup>|4|The special values +∞, -∞, NaN & negative 0, plus values from -_a_ to _a_ where _a_ = 3.402823 × 10<sup>38</sup>.<BR><BR>The value mustn't have more than 24 significant binary digits & 126 binary places, when the value is a non-special value with an absolute value ≥ 2<sup>−126</sup>.<BR><BR>When 0 < &vert;_the value_&vert; < 2<sup>−126</sup>, the value must be able to be written as ±p ÷ 2<sup>(126 + 23)</sup> for some natural number _p_ for which &vert;_p_&vert; ≤ (2<sup>23</sup> - 1).<BR><BR>Note that all integers with 6 or fewer significant decimal digits, where -_a_ ≤ _the integer_ ≤ _a_ and _a_ = 3.402823 × 10<sup>38</sup>, are in the range.|
|_Variable&#8209;length_<BR>**[String](string-data-type.md)**|4 + _**LongPtr**&nbsp;storage&nbsp;size_ + ((_string&nbsp;length_&nbsp;+&nbsp;1)&nbsp;&times;&nbsp;2)|Each character can be any Unicode character; length of string can be changed to any non-negative integer up to approximately 2 billion.|
|_Fixed&#8209;length_<BR>**String**|_Length of string_ &times; 2|Each character can be any Unicode character; length of string can be set to any positive integer up to approximately 65,400; string length can only be set during execution of the variable's declaration|
