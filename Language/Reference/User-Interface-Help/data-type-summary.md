...
|**[Date](date-data-type.md)**|Date & time in range from&nbsp;&nbsp;January&thinsp;1,&thinsp;100&thinsp;AD,&thinsp;00:00.00&thinsp;AM,&nbsp;&nbsp;to&nbsp;&nbsp;December&thinsp;31,&thinsp;9999&thinsp;AD,&thinsp;23:59.59&thinsp;PM&nbsp;&nbsp;whenever the time can be accurately expressed purely as an integeric number of seconds after midnight; for dates & times within the upper- & lower-bound of this range, where the times are not expressible as such, they may still be able to be accurately stored in this data type.|8|
...
|:--------|:-----------|----:|
|Any|Data of:<br><ul><li>any non-array data type except the fixed-length **String** type & user-defined types declared in the VBE using VBA's **Type** statement,<li>any array data type except if the element type is the fixed-length **String** type or a user-defined type declared in the VBE using VBA's **Type** statement,<li>the **Variant** [**Error**](../../reference/user-interface-help/cverr-function.md) sub-type, _or_<li>the **Variant** [**Decimal**](../../reference/user-interface-help/decimal-data-type.md) sub-type,</ul>_or_ one of the following special values:<ul><li>[**Empty**](../../Glossary/vbe-glossary.md#empty) <sup>_(**Variant** value)_.</sup><li>[**Null**](../../Glossary/vbe-glossary.md#null) <sup>_(**Variant** value)_.</sup><li>[**Nothing**](../../Reference/User-Interface-Help/nothing-keyword.md) <sup>_(object-based value)._</sup><li>the special value representing a [missing procedure argument](../../Reference/User-Interface-Help/ismissing-function.md) (a **Variant** value).</ul>|≥ 16<BR>(exact amount depends on specific kind of data)|
