...
|**[Currency](currency-data-type.md)**<BR><sup>_(scaled integer)_</sup>|8|-_a_&nbsp;&nbsp;to&nbsp;&nbsp;(_a_&thinsp;-&thinsp;0.0001)&nbsp;&nbsp;where<BR>&nbsp;&nbsp;&nbsp;_a_ ⪆ 9 × 10<sup>14</sup> &<BR>&nbsp;&nbsp;&nbsp;value must have no more than 4 decimal places,<p align="right">_a_ = 922,&thinsp;337,&thinsp;203,&thinsp;685,&thinsp;477.5808 (≈ 922 trillion).</p>|
...
|**[Decimal](decimal-data-type.md)**|14|Integer with an absolute value less than 79,&thinsp;228,&thinsp;162,&thinsp;514,&thinsp;264,&thinsp;337,&thinsp;593,&thinsp;543,&thinsp;950,&thinsp;336&thinsp;, or a number from this range after it has been scaled down by 10<sup>a</sup> where _a_ can be any natural number under 29.|
...
|**[Integer](integer-data-type.md)**|2|Integer in range from -_a_ to (_a_ - 1) where _a_ = 32,&thinsp;768|
|**[Long](long-data-type.md)**<BR><sup>_(Long integer)_<sup>|4|Integer in range from -_a_ to (_a_ - 1) where _a_ = 2,&thinsp;147,&thinsp;483,&thinsp;648|
|**[LongLong](longlong-data-type.md)**<BR><sup>_(LongLong integer)_<sup>|8|Integer in range from -_a_ to (_a_ - 1) where _a_ = 9,&thinsp;223,&thinsp;372,&thinsp;036,&thinsp;854,&thinsp;775,&thinsp;808<br/><br/>Valid on 64-bit platforms only.|
...
|_Fixed&#8209;length_<BR>**String**|_Length of string_ &times; 2|Each character can be any Unicode character; length of string can be set to any positive integer up to approximately 65,&thinsp;400; string length can only be set during execution of the variable's declaration|
