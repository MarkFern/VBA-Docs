...
|**[LongPtr](longptr-data-type.md)** <BR><sup>_(Long integer on 32-bit systems,<BR>LongLong integer on 64-bit systems)_<sup>|4 on 32-bit systems<br/><br/>8 on 64-bit systems|Ranges for bit version of number, are:<BR> - **0000**0000 to **FFFF**FFFF<BR>&nbsp;&nbsp;&nbsp;on 32-bit systems, \&<BR> - **0000**0000**0000**0000 to **FFFF**FFFF**FFFF**FFFF<BR>&nbsp;&nbsp;&nbsp;on 64-bit systems.|
