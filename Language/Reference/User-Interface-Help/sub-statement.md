...
The data types specified for arguments in a **Sub** procedure definition, are often identical to the data types required by the corresponding parameters of standard [procedure calls](../../glossary/vbe-glossary.md#procedure-call) of the **Sub** procedure. However, when the **Sub** procedure specifies a **Variant**, **Object**, or a specific object type for an argument, automatic implicit type conversions sometimes take place such that the range of the call parameter is broader than the range of the argument type specified by the **Sub** procedure. See the ['Implicit conversions'](data-type-summary.md#implicit-conversions) section on the 'Data type summary' page for more information.
