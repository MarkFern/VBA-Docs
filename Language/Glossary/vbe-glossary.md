...
A non-property procedure that is an intrinsic procedure of an object. When composed using the VBE, its composition is contained within a [class module](#class-module). Methods are always [class](#class) procedures.
