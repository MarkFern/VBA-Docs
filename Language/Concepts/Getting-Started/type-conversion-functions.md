...
|**CVar**|[Variant](../../reference/user-interface-help/variant-data-type.md)|Same range as **Double** for numerics. Same range as **String** for non-numerics. [**User-defined types**](../../how-to/user-defined-data-type.md) (UDTs) defined in VBE using VBA's [**Type**](../../reference/user-interface-help/type-statement.md) statement are not permitted. UDTs accessed through [VBE library references](../../reference/user-interface-help/references-dialog-box.md) will likely be accepted. Likewise any [object data type](../../glossary/vbe-glossary#object-type.md) will likely be accepted.|
